            ...
            <nav style={S.nav}>
                <div style={S.navInner}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <span style={{ color: '#94a3b8', fontSize: 14 }}>Danh mục sản phẩm</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                        <button onClick={() => navigate('/')} style={{ background: '#1e293b', border: '1px solid #334155', color: '#94a3b8', borderRadius: 10, padding: '6px 14px', cursor: 'pointer', fontSize: 13, fontWeight: 600, transition: 'all .2s' }}>
                            Trang chủ
                        </button>
                        <button onClick={() => navigate('/search')} style={{ background: '#1e293b', border: '1px solid #334155', color: '#94a3b8', borderRadius: 10, padding: '6px 14px', cursor: 'pointer', fontSize: 13, fontWeight: 600, transition: 'all .2s' }}>
                            🔍 Tìm kiếm
                        </button>
